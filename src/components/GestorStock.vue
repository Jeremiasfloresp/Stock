<template>
  <div>
    ...
    <form @submit.prevent="modoEdicion ? actualizarProducto() : agregarProducto()">
      ...
      <input v-model.number="nuevo.precioUnitario"  placeholder="Precio Unitario"  type="text"  @input="nuevo.precioUnitario = parseFloat(nuevo.precioUnitario.replace(',', '.'))"  required/>
